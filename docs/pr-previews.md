...
jobs:
  build:
    ...
    steps:
      ...
      # Replace with your real install/build commands (or the main `Archetipo95/storybook-github-pages@v1.9.11`
      ...
      - name: Package and upload preview bundle
        uses: Archetipo95/storybook-github-pages/preview-build@v1.9.11
        with:
...
jobs:
  publish:
    uses: Archetipo95/storybook-github-pages/.github/workflows/pr-preview-publish.yml@v1.9.11
    with:
...
steps:
  ...
  - name: Validate provenance and publish preview
    uses: Archetipo95/storybook-github-pages/preview-publisher@v1.9.11
    with:
...
jobs:
  cleanup:
    uses: Archetipo95/storybook-github-pages/.github/workflows/pr-preview-cleanup.yml@v1.9.11
    with:
      preview_root: '' # optional: override preview root; defaults to .storybook-pages.yml or 'pr-preview'
      pages_branch: 'gh-pages'
```
...
steps:
  ...
  - name: Remove preview directory
    uses: Archetipo95/storybook-github-pages/preview-cleanup@v1.9.11
    with:
      pages_repo: pages-repo
      pages_branch: gh-pages
      preview_root: ''
...
jobs:
  janitor:
    uses: Archetipo95/storybook-github-pages/.github/workflows/pr-preview-janitor.yml@v1.9.11
    with:
      preview_root: ''
      pages_branch: 'gh-pages'
      retention_days: '30'
...
steps:
  ...
  - name: Prune stale previews
    uses: Archetipo95/storybook-github-pages/preview-janitor@v1.9.11
    with:
      pages_repo: pages-repo
      pages_branch: gh-pages
      preview_root: ''
